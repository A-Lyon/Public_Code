...
//  turning in a screenshot of the code showing test cases failing
//  need screenshot 4 green checkmarks, and one with 2 red x's
...
//	TestingFunctions functions = new BlackBoxCorrect();
	...
	public void testGCDNegative(){
		...
		assertEquals("Error: should return 5", 5, functions.greatestCommonDivisor(-5, -10));
	...
	public void testReverseWindow() {
		...
		functions.reverseWindow(start, 0, 2);
