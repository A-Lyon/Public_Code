...
class BarGraph<char> {
  ...
  public:
    ...
    friend ostream& operator<< (ostream& out, const BarGraph<char>& barG ){
        ...
        out << '\n';
        //out << "I really wish we had enough information to put this together, its nothing like anything weve seen. Thanks! Love c++ now, you have made it such an amazing class" << '\n';
        return out;
    }
};
