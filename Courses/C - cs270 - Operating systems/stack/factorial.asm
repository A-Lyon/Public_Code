...
Factorial       ADD R6, R6, #-1     ; Step 3: allocate space for return value
                ...
                ADD R5, R6, #-1     ; Step 6: setup new frame pointer (points to 1st local var)
...
Checkpoint1     LDR   R0, R5, #4    ; Load parameter N into a register
                ...
                PUSH R5             ; Step 1: push parameter N - 1
                JSR Factorial       ; Step 2: call Factorial(N - 1)
                LDR R2, R5, #3       ; Step 13: retrieve return value into R2
...
Main            LD    R6, Stack     ; Initialize stack pointer
                ...
                JSR Factorial       ; Step 2: call Factorial(Param is R0 that we already pushed)
...
TheEnd          HALT
    ...
    ;from recitation quiz, this might help!            
...
;ADD R6, R6, #-2; space for Q’s local variables
