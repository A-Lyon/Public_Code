...
using namespace std;
    ...
    [[nodiscard]] bool Phobic::is_scary(int checkMeOut){
    ...
    Phobic &Phobic::operator/=(const Phobic& rhs){
      ...
      if (rhs.get() == 0){
        	throw runtime_error("./test: invalid args, divide by zero with operands: " + to_string(this->get()) + " and " + to_string(rhs.get()) + "./n");
      } 
      scardy /= rhs.scardy;  
      return *this;
    }
